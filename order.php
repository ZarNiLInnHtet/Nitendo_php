...
<?php
   ...
   if(isset($_REQUEST['order_id'])){
       ...
       $sqlorder_id = "SELECT * FROM `product` WHERE `product_id` = '$order_id'   " ;

       $resultorder_id = mysqli_query ($con,$sqlorder_id);

       if($resultorder_id){
           $order_each= mysqli_fetch_assoc ($resultorder_id);
       }
...
if(isset($_POST['buy'])){
      ...
      $customer_email1 = $_POST ['customer_email1'];
      $customer_address1 = $_POST ['customer_address1'];
      $order_name= $order_each['product_name'];
      $customer_phone1= $_POST['customer_phone1'];

      $order_size= $order_each ['size'];
     
      $order_price = $order_each ['price'];



      $sql5= "INSERT INTO `order_list` ( `customer_name` , `customer_email` , `customer_address` , `order_name` ,
      `phone number` , `order_size`  , `order_price`) VALUES ('$customer_name1' , '$customer_email1' ,
      '$customer_address1' , '$order_name' , '$customer_phone1' , '$order_size'  , '$order_price' ) " ;


     $result5= mysqli_query($con,$sql5);

     if($result5){
         echo "<script>  alert('Add to cart successfuly');
...
<body>
    ...
    <div class="each_container" id="each_containers">
                     ...
                     <div class="each_image">
                         <img class="each_image_show" src="for nitendo/<?php echo $order_each['product_image'];  ?>" alt="">
                     </div> <br> <br> <br>
                     ...
                     <div class="each_detail">
                        ...
                        <h1>Please Submit Form </h1> <br>
     
     
     
     <label for="">Full name</label>
     <input type="text" name="customer_name1" required autofocus> <br> <br>
     
     <label for="">Email</label>
     <input type="text"  name="customer_email1" required> <br> <br>
     
     <label for="">Address</label>
     <input type="text"  name="customer_address1" required> <br> <br>


     <label for="">Phone Number</label>
     <input type="text"  name="customer_phone1" required> <br> <br>
     
     
     
     <input class="btn btn-lg  mt-3" id="btview" type="submit" name="buy" value="Buy" onclick="return confirm('Are u sure u want to buy');">
